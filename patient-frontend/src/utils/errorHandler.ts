...
const PHARMACY_MESSAGE_OVERRIDES: Array<{ match: string; key: string }> = [
  { match: 'out of stock', key: 'pharmacy.errors.outOfStock' },
  { match: 'unavailable in the hospital pharmacy', key: 'pharmacy.errors.unavailable' },
  { match: 'too low to purchase this prescription', key: 'pharmacy.errors.insufficientBalancePrescription' },
  { match: 'wallet balance is too low', key: 'pharmacy.errors.insufficientBalance' },
  { match: 'wallet balance', key: 'pharmacy.errors.insufficientBalance' },
  { match: 'prescription could not be found', key: 'pharmacy.errors.itemNotFound' },
  { match: "isn't part of one of your prescriptions", key: 'pharmacy.errors.itemNotFound' },
  { match: 'is already cancelled', key: 'pharmacy.errors.alreadyCancelled' },
];
...
// We keep those names (patients benefit from knowing which medicine is the problem)
// but otherwise show our own friendly sentence instead of the raw backend wording.
