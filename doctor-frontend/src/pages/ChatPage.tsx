...
function groupChatsByPatient(chats: ChatSummaryDto[], myUserId: string): PatientGroup[] {
...
function PatientGroupCard({ group, activeChatId, onSelectChat }: {
  group: PatientGroup; activeChatId: string | undefined; onSelectChat: (id: string) => void;
}) {
...
export function ChatPage() {
  ...
  const patientGroups = useMemo(() => groupChatsByPatient(chats, myUserId), [chats, myUserId]);
